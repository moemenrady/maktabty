...
class UserRiverpod extends StateNotifier<UserRiverpodState> {
  ...
  Future<void> getUserInfo(String userId) async {
    ...
    result.fold(
      ...
      state = state.copyWith(
          state: userState.success, username: newname, userphone: newphone);
    });
  }
}
