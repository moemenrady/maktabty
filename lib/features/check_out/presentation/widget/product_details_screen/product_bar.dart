        ...
        child: Row(
          ...
          children: [
            TextButton(
              onPressed: () {},
              style: ButtonStyle(
                backgroundColor: WidgetStateProperty.all(const Color(0xFFF68B3B)),
                minimumSize: WidgetStateProperty.all(const Size(97, 38)),
            ...
            Container(
              ...
              width: 38,
              decoration: BoxDecoration(
                color: const Color.fromARGB(131, 246, 140, 59),
